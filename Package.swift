...
let package = Package(
    ...
    products: [
        ...
        .library(
            ...
            targets: ["UserModuleMigrationKit"]
        ),
        .library(
            name: "UserModuleDatabaseKit",
            targets: ["UserModuleDatabaseKit"]
        ),
    ],
    dependencies: [
        ...
        .package(
            url:
                "https://github.com/feather-framework/feather-mail-driver-memory",
        ...
        .package(
            url:
                "https://github.com/feather-framework/feather-database-driver-sqlite",
            .upToNextMinor(from: "0.4.0")
        ),
        .package(
            url: "https://github.com/feather-framework/feather-module-kit",
            .upToNextMinor(from: "0.5.0")
        ),
        .package(
            url: "https://github.com/feather-modules/feather-system-module",
        ...
        .target(
            ...
            dependencies: [
                .product(
                    ...
                    package: "feather-module-kit"
                ),
                .product(
                    name: "SystemModuleKit",
                    package: "feather-system-module"
                ),
        ...
        .testTarget(
            ...
            dependencies: [
                ...
                .product(
                    ...
                    package: "feather-mail-driver-memory"
                ),
                .product(
                    name: "FeatherPushDriverMemory",
                    package: "feather-push-driver-memory"
                ),
                .product(
                    name: "FeatherDatabaseDriverSQLite",
                    package: "feather-database-driver-sqlite"
                ),
            ]
        ),
    ]
